...
wofi_command = f"echo '{output}' | wofi --conf=~/.config/wofi/config --show=dmenu --hide-scroll --allow-markup --define=hide_search=true --location=bottom_left --width=600 --height=200 --xoffset=5 --yoffset=-60"
